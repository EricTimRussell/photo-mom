<template>
  ...
  <section>
    <div class="grid grid-col-3 pt-10">
      <h2 class="col-start-2 text-3xl">Welcome Introduction</h2>
    </div>
    <div class="grid grid-col-3 pt-5">
      <span class="col-start-2 bg-slate-500 h-1 w-20"></span>
    </div>
    <div class="grid grid-cols-5 pt-3">
      <p class="col-start-2 col-span-3 px-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate, odit
        quos
        ea,
  ...
  <!-- Featured Images -->
  <section>
    <div class="grid grid-cols-5 gap-10 pt-20">
      <!-- row 1 -->
      <img class="col-start-2 rounded" src="https://thiscatdoesnotexist.com/" alt="">
      <img class="rounded" src="https://thiscatdoesnotexist.com/" alt="">
      <img class="rounded" src="https://thiscatdoesnotexist.com/" alt="">
      <!-- row 2 -->
      <img class="col-start-2 rounded" src="https://thiscatdoesnotexist.com/" alt="">
      <img class="rounded" src="https://thiscatdoesnotexist.com/" alt="">
  ...
  <section>
    <div class="grid grid-col-3 pt-10">
      <h2 class="col-start-2 text-3xl">About Section</h2>
    </div>
    <div class="grid grid-col-3 pt-5">
      <span class="col-start-2 bg-slate-500 h-1 w-20"></span>
    </div>
    <div class="grid grid-cols-5 pt-3 pb-20">
      <p class="col-start-2 col-span-3 px-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate, odit
        quos
        ea,
        temporibus quas obcaecati
